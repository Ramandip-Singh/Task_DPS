...
const Introduction = () => {
  ...
  return (
    <div className='w-full flex flex-col md:flex-row justify-center items-center ps-[32px] py-[32px] gap-2 bg-[#F9F9F9]'>
      <div className='w-[100%] sm:w-[80%] md:w-[60%] flex items-center justify-center p-[0px] sm:p-[16px]'>
         <div className='w-[100%] md:[80%] flex-col gap-1 items-center justify-end'>
        <span className="block text-[20px] sm:text-[28px] text-[#000000] font-['Kameron'] font-semibold">Welcome To DPS Yamuna Nagar:</span>
        <span className="block text-[20px] sm:text-[28px] text-[#000000] font-['Kameron'] font-semibold">The Best CBSE School In Haryana</span>
