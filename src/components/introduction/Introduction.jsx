...
const Introduction = () => {
  ...
  return (
    <div className='w-full flex flex-row justify-center items-center ps-[32px] py-[32px] bg-[#F9F9F9]'>
      <div className='w-[45%] flex-col gap-1 '>
      ...
      <div className='w-[45%] bg-[#FFBB04] rounded-l-xl overflow-hidden px-[32px] py-[24px] flex items-center ml-auto '>
